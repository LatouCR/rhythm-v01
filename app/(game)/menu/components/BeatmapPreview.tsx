...
export default function BeatmapPreview({ beatmaps }: BeatmapResponse) {
    ...
    return (
        <div className="w-screen h-screen flex items-end flex-col gap-2 bg-white">
            ...
            <div className="absolute bottom-0 w-full max-h-[150px] flex flex-col justify-center items-start pointer-events-none">
                <div className="w-2/3">
                    <AudioVisualizer analyser={analyser} />
                </div>
                <div className="border-t-2 border-red-500 min-h-[80px] w-full justify-between items-center flex px-4 py-2 pointer-events-auto bg-black">
